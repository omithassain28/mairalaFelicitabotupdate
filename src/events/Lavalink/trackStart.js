...
<:req:1199978800923037757> **Requester**\n${track.requester.tag}`,
    )
  ...
  const But1 = new MessageButton()
    .setEmoji("<:Volume_less:1199969731235549224>")
    .setCustomId("vdown")
    .setStyle("SECONDARY");

  const But2 = new MessageButton()
    .setEmoji("<:icons_stop_button:1199968797369565275>")
    .setCustomId("stop")
    .setStyle("SECONDARY");

  const But3 = new MessageButton()
    .setCustomId("pause")
    .setEmoji("<:icon_pause:1199976570241167470>")
    .setStyle("SECONDARY");

  const But4 = new MessageButton()
    .setCustomId("skip")
    .setEmoji("<:icon_skip:1199969957472124958>")
    .setStyle("SECONDARY");

  const But5 = new MessageButton()
    .setCustomId("vup")
    .setEmoji("<:Volume_up:1199969812999311401>")
    .setStyle("SECONDARY");
